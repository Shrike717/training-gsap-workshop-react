...
const GsapStagger = () => {
	...
	useGSAP(() => {
		gsap.to('.stagger-box', {
			y: 250, // Move 250px down
			rotation: 360, // Rotate 360 degrees
			borderRadius: '100%', // Make it a circle
			repeat: -1, // Repeat forever
			yoyo: true, // Reverse the animation
			// stagger: 0.5, // Stagger (heisst staffeln) the animations by 1.5 seconds
			stagger: {
				amount: 1.5, // Stagger (heisst staffeln) the animations by 1.5 seconds
