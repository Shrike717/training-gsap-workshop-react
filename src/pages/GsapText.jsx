...
const GsapText = () => {
	...
	useGSAP(() => {
		// The heading text will fade in and slide up
		gsap.to('#text', {
			opacity: 1,
			y: 0,
			ease: 'power1.inOut',
		...
		// The paragraph text will fade in and slide up
		gsap.fromTo(
			'.para',
			{
				opacity: 0,
			...
			},
			{
				...
				y: 0,
				delay: 0.5,
				stagger: 0.1, // Stagger the animations by 0.1 seconds. This will create a delay between each paragraph text animation
			}
		);
	}, []);
	...
	return (
		<main>
			{/* opacity-0: Text is hidden a the start and then becomes visible with animation */}
